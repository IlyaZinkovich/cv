...
import by.bsu.zinkovich.imagefunctions.*;
...
public class OpenCVController
{
	...
	protected void init() {
        ...
        fileChooser.setInitialDirectory(new File("C:/Users/Ilya_Zinkovich/Desktop"));
		this.image = new Mat();
	}
	...
	public void onLoadImageButtonPressed() {
		...
		if (file != null) {
            ...
            originalImageView.setImage(mat2Image(originalImage));
